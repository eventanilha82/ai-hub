...
class AppUnitTests(TestCase):
    def setUp(self) -> None:
        ...
        self.loading_placeholder = MagicMock()
        self.loading_placeholder.__enter__.return_value = self.loading_placeholder
        self.loading_placeholder.__exit__.return_value = False
